...
class Keyboard extends StatelessWidget {
  final KeyboardConfig keyboardUIConfig;
  final KeyboardTapCallback onKeyboardTap;
  final Function onDeleteCancelButtonPressed;
  final Widget button;
  ...
  Keyboard(
      ...
      this.digits,
      this.button,
      this.onDeleteCancelButtonPressed})
      : super(key: key);
  ...
  Widget _buildKeyboard(BuildContext context) {
    ...
    return Container(
      ...
      child: AlignedGrid(keyboardSize: keyboardSize, children: [
        _buildKeyboardDigit(text: keyboardItems[0]),
        _buildKeyboardDigit(text: keyboardItems[1]),
        _buildKeyboardDigit(text: keyboardItems[2]),
        _buildKeyboardDigit(text: keyboardItems[3]),
        _buildKeyboardDigit(text: keyboardItems[4]),
        _buildKeyboardDigit(text: keyboardItems[5]),
        _buildKeyboardDigit(text: keyboardItems[6]),
        _buildKeyboardDigit(text: keyboardItems[7]),
        _buildKeyboardDigit(text: keyboardItems[8]),
        _buildKeyboardDigit(text: keyboardItems[9]),
        _buildKeyboardDigit(text: keyboardItems[10]),
        _buildKeyboardDigit(
            del: true,
            onTap: () {
  ...
  Widget _buildKeyboardDigit({text, del = false, onTap}) {
    return Container(
